...
export const scatteredCloudsDay = {
    component: () =>
        <g>
            <path d="M62.8,69H26.6c-0.5,0-0.9-0.1-1.3-0.2c-8-1.2-13.8-7.6-13.8-15.8c0-8.1,5.4-14.3,13.2-15.7c0.4-1.6,1-3.6,2-5.6 c3.2-6.2,9-9.6,16.5-9.6c7.4,0,13.3,3.4,16.5,9.6c1,1.9,1.6,3.8,2,5.3h1.1c9.7,0,16.7,6.7,16.7,16C79.5,62.1,72.3,69,62.8,69z M28.2,61h34.6c6,0,8.7-4.1,8.7-8c0-4.8-3.5-8-8.7-8h-4.5c-2.1,0-3.9-1.7-4-3.8c0,0-0.2-3.1-1.8-6c-1.9-3.5-5-5.1-9.4-5.1 C32.8,30,32.2,40,32.2,41.1c-0.1,2.2-1.8,3.9-4,3.9c-5.2,0-8.7,3.2-8.7,8C19.5,56.8,22.2,61,28.2,61z"/>
        </g>
};
export const scatteredCloudsNight = scatteredCloudsDay;
...
export const brokenCloudsNight = brokenCloudsDay;
...
export const showerRainDay = {
    component: () =>
        <g>
            ...
            <path d="M34.7,43.5c-1.9-0.5-3.8,0.6-4.3,2.5l-5.6,20.7c-0.5,1.9,0.6,3.8,2.5,4.3c0.3,0.1,0.6,0.1,0.9,0.1c1.5,0,3-1,3.4-2.6 l5.6-20.7C37.7,45.9,36.6,44,34.7,43.5z"/>
            <path d="M44.4,51.6c-1.9-0.5-3.8,0.6-4.3,2.5l-5.6,20.7c-0.5,1.9,0.6,3.8,2.5,4.3c0.3,0.1,0.6,0.1,0.9,0.1c1.5,0,3-1,3.4-2.6 l5.6-20.7C47.3,54.1,46.2,52.2,44.4,51.6z"/>
            <path d="M58.4,43.5c-1.9-0.5-3.8,0.6-4.3,2.5l-5.6,20.7c-0.5,1.9,0.6,3.8,2.5,4.3c0.3,0.1,0.6,0.1,0.9,0.1c1.5,0,3-1,3.4-2.6 l5.6-20.7C61.4,45.9,60.3,44,58.4,43.5z"/>
        </g>
};
export const showerRainNight = showerRainDay;
...
export const rainNight = {
    component: () =>
        <g>
            ...
            <path d="M34.9,68.1c-0.8,0-1.5,0.4-2,1c-0.9,1.2-4,5.5-4,8.5c0,3.9,3,6.3,6,6.3s6-2.4,6-6.3c0-3.1-3-7.3-4-8.5 C36.4,68.5,35.7,68.1,34.9,68.1z"/>
            ...
            <path d="M41,50.8c-0.5,0-0.9,0.2-1.2,0.6c-0.6,0.8-2.6,3.6-2.6,5.6c0,2.5,1.9,4,3.8,4h0c1.9,0,3.8-1.5,3.8-4 C44.8,55.7,42.6,50.8,41,50.8z"/>
...
export const thunderstormDay = {
    component: () =>
        <g>
            <path d="M62.8,29.5h-1.1c-0.4-1.6-1-3.4-2-5.3c-3.3-6.2-9.2-9.6-16.5-9.6c-7.4,0-13.3,3.4-16.5,9.6c-1,2-1.6,4-2,5.6 c-7.8,1.4-13.2,7.6-13.2,15.7c0,7.5,4.9,13.7,12.3,15.5c2.1,0.5,4.3-0.8,4.8-3c0.5-2.1-0.8-4.3-3-4.8c-3.7-0.9-6.1-3.9-6.1-7.7 c0-4.8,3.5-8,8.7-8c2.2,0,3.9-1.7,4-3.9c0-1.1,0.6-11.1,10.9-11.1c4.4,0,7.5,1.7,9.4,5.1c1.6,2.9,1.8,6,1.8,6 c0.1,2.1,1.9,3.8,4,3.8h4.5c5.2,0,8.7,3.2,8.7,8c0,3.9-2.7,8-8.7,8c-2.2,0-4,1.8-4,4s1.8,4,4,4c9.5,0,16.7-6.9,16.7-16 C79.5,36.3,72.5,29.5,62.8,29.5z"/>
            <path d="M52.2,54.6h-4.4l5.5-7.7c0.3-0.5,0.4-1.1,0.1-1.6c-0.3-0.5-0.8-0.8-1.3-0.8H41.1c-0.6,0-1.2,0.4-1.4,1l-6.1,15.8 c-0.2,0.5-0.1,1,0.2,1.4c0.3,0.4,0.7,0.6,1.2,0.6h0l3.2,0l-4.2,11c-0.3,0.7,0,1.4,0.6,1.8c0.2,0.1,0.5,0.2,0.8,0.2 c0.4,0,0.8-0.2,1.1-0.5l16.6-18.8c0.4-0.4,0.5-1.1,0.2-1.6S52.7,54.6,52.2,54.6z"/>
        </g>
};
export const thunderstormNight = thunderstormDay;
...
export const snowNight = snowDay;

export const mistDay = {
    component: () =>
        <g>
            <path d="M11,49c2.2,0,4-1.8,4-4c0-4.8,3.5-8,8.7-8c2.2,0,3.9-1.7,4-3.9C27.8,32,28.4,22,38.7,22c4.4,0,7.5,1.7,9.4,5.1 c1.6,2.9,1.8,6,1.8,6c0.1,2.1,1.9,3.8,4,3.8h4.5c5.2,0,8.7,3.2,8.7,8c0,2.2,1.8,4,4,4c2.2,0,4-1.8,4-4c0-9.3-7-16-16.7-16h-1.1 c-0.4-1.6-1-3.4-2-5.3c-3.3-6.2-9.2-9.6-16.5-9.6c-7.4,0-13.3,3.4-16.5,9.6c-1,2-1.6,4-2,5.6C12.4,30.7,7,36.9,7,45 C7,47.2,8.8,49,11,49z"/>
            <path d="M62.6,58.6c0-1.9-1.6-3.5-3.5-3.5H10.7c-1.9,0-3.5,1.6-3.5,3.5c0,1.9,1.6,3.5,3.5,3.5h48.5C61.1,62.1,62.6,60.5,62.6,58.6z "/>
            <path d="M80.5,70H25.3c-1.9,0-3.5,1.6-3.5,3.5c0,1.9,1.6,3.5,3.5,3.5h55.2c1.9,0,3.5-1.6,3.5-3.5C84,71.5,82.4,70,80.5,70z"/>
            <path d="M71.5,54.6h-0.2c-2.2,0-4,1.8-4,4s1.8,4,4,4h0.2c2.2,0,4-1.8,4-4S73.7,54.6,71.5,54.6z"/>
        </g>
};
export const mistNight = mistDay;
...
export default function iconByCodeAndDay(code, day) {
